...
- *"Staying on the Manifold: Geometry-Aware Noise Injection"*, A.K. Jacobsen*, J.M. Gegenfurtner*, G. Arvanitidis (Northern Lights Deep Learning Conference 2026)
  ...
  [![PDF](https://img.shields.io/badge/PDF-red?logo=adobeacrobatreader&logoColor=white)](https://openreview.net/pdf?id=GRk65sJxpn)
  [![Code](https://img.shields.io/badge/Code-blue?logo=github&logoColor=white)](https://github.com/albertkjoller/geometric-ml/tree/main/staying-on-the-manifold)
...
- *"Reducing Memorisation in Generative Models via Riemannian Bayesian Inference"*, J.M. Gegenfurtner*, A.K. Jacobsen*, N.E. Borras, A.V. Mahou, G. Arvanitidis (preprint) 
  ...
  [![PDF](https://img.shields.io/badge/PDF-red?logo=adobeacrobatreader&logoColor=white)](https://arxiv.org/pdf/2602.00199)
  [![Code](https://img.shields.io/badge/Code-blue?logo=github&logoColor=white)](https://github.com/albertkjoller/geometric-ml/tree/main/reducing-memorisation-in-generative-models)
